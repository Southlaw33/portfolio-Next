...
const NavigationBar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 w-full transition-all backdrop-blur-lg bg-opacity-30 ${
        currentTheme === "dark"
          ? "bg-gradient-to-br from-[#000000f5] to-[#1c211c]"
          : "bg-gradient-to-br from-[#a7c5d7] to-[#f7d6e0]"
      }`}
    >
      <div className="container mx-auto flex justify-between items-center px-4 py-4">
        ...
        <div className="hidden md:flex items-center space-x-6 ml-auto">
          ...
          <Link href="/education" className={buttonClass}>
            Education
          </Link>
        ...
        <button
          onClick={toggleMenu}
          className={`md:hidden text-xl ${themeClass}`}
        >
      ...
      <div
        className={`md:hidden ${menuOpen ? "block" : "hidden"} ${
          currentTheme === "dark"
            ? "bg-gradient-to-br from-[#000000f5] to-[#000000]" //#000000f5, #1c211c
            : "bg-gradient-to-br from-[#a7c5d7] to-[#f7d6e0]"
        } backdrop-blur-lg bg-opacity-30 transition-all duration-300`}
      >
